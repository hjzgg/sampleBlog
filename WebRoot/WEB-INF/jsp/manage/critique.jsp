...
<div class="ibody">
  ...
  <article>
    <h2 class="about_h">您现在的位置是：<a href="../manage/article">首页</a>><a href="#">留言板</a></h2>
    <div class="template">
       ...
       <s:iterator value="critiques" >
        <dl>
          ...
          <dd><s:property value="name"/>
            <time><s:property value="time"/></time>&nbsp;&nbsp;<a href="critique_delete?id=<s:property value="id" />" class="dellink"><span style="color:red;">删除</span></a>
          </dd>
