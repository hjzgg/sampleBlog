...
<div class="ibody">
    ...
    <div class="page">
       ...
       <form action="../critique/critique_add" method="post" >
      		<table>
      			...
      			<tr>
	    			<td><span>留言内容:</span><textarea name="critique.content" style="width:600px;height:150px;" ></textarea></td>
  ...
  <aside>
    <div class="rnav">
      <li class="rnav1 "><a href="#">个人博客</a></li>
      <li class="rnav2 "><a href="#">最新动态</a></li>
